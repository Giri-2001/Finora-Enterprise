...
//
// ANDROID SIGNED WALLET RECHARGE PACKAGE APPLY SERVICE
//
// Native Android adapter for verified signed WALLET_RECHARGE
// Control Packages.
//
// SECURITY:
//
...
public final class FinoraWalletRechargePackageApplyService {

    private final FinoraWalletRechargeApplyCoordinator coordinator;


    public FinoraWalletRechargePackageApplyService(
    ...
    public static final class ApplyResult {
        ...
        private static ApplyResult fromCoordinator(
            FinoraWalletRechargeApplyCoordinator.Result result
        ) {
    ...
    public ApplyResult apply(
        ...
        if (signedPackage == null) {
            ...
            return new ApplyResult(
                false,
                "FINORA signed Wallet Recharge package is required.",
                null,
                null
            );
        }
        ...
        try {
            ...
            return new ApplyResult(
                ...
                error.getMessage() != null
                    ? error.getMessage()
                    : "Unable to prepare FINORA signed Wallet Recharge package.",
                null,
                null
            );
        }
    ...
    private static final class AndroidNativeBindingPort
        ...
        implements
            FinoraWalletRechargeApplyCoordinator.NativeBindingPort {
        ...
        @Override
        public FinoraWalletRechargeApplyCoordinator.NativeBinding read()
            throws Exception {
            ...
            return new FinoraWalletRechargeApplyCoordinator.NativeBinding(
    ...
    private static final class EncryptedControlStatePort
        ...
        public void write(
             ...
             *
             * FinoraControlStore supplies Android Keystore
             * AES-256-GCM + authenticated AtomicFile replacement.
             */
            controlStore.write(
