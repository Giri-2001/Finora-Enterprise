...
export type LoanStudioThemeStyle = CSSProperties &
...
function getThemeVisuals(theme?: FinoraTheme) {
  if (theme) {
    return {
      ...
      primaryHover: theme.colors.brand.secondary,

      primarySoft: theme.colors.brand.accentSoft,
      ...
      successBorder: theme.colors.border.strong,
      ...
      dangerSoft: theme.colors.status.dangerSoft,

      info: theme.colors.status.info,

      infoSoft: theme.colors.status.infoSoft,

      overlayShadow: theme.colors.overlay.shadow,

      overlayBackdrop: theme.colors.overlay.backdrop,
    };
  }

  return {
    page: "var(--finora-theme-background-page, var(--finora-theme-page, #0B1220))",
    ...
    surfaceStrong: "var(--finora-theme-surface-strong, #17263D)",
    ...
    overlayShadow: "var(--finora-theme-overlay-shadow, rgba(0,0,0,.24))",

    overlayBackdrop: "var(--finora-theme-overlay-backdrop, rgba(15,23,42,.48))",
  };
}
...
export interface LoanStudioStyles {
  shellStyle: LoanStudioThemeStyle;

  contentStyle: CSSProperties;

  footerStyle: CSSProperties;

  stepListStyle: CSSProperties;

  stepItemStyle: CSSProperties;

  activeStepNumberStyle: CSSProperties;

  activeStepTitleStyle: CSSProperties;

  completedStepNumberStyle: CSSProperties;

  completedStepTitleStyle: CSSProperties;

  pendingStepNumberStyle: CSSProperties;

  pendingStepTitleStyle: CSSProperties;

  stepSubtitleStyle: CSSProperties;
  ...
  disabledNavigationButtonStyle: CSSProperties;

  primaryNavigationButtonStyle: CSSProperties;
...
export function createLoanStudioStyles(
  ...
  const navigationButtonStyle: CSSProperties = {
    ...
    border: `${border.width}px solid ${colors.border}`,
  ...
  return {
    shellStyle: {
      ...
      boxShadow: `0 12px 34px ${colors.overlayShadow}`,
    ...
    activeStepNumberStyle: {
      ...
      border: `${border.width}px solid ${colors.primaryHover}`,
...
const DEFAULT_STYLES = createLoanStudioStyles(LAPTOP_TOKENS);

export const shellStyle = DEFAULT_STYLES.shellStyle;

export const contentStyle = DEFAULT_STYLES.contentStyle;

export const footerStyle = DEFAULT_STYLES.footerStyle;

export const stepListStyle = DEFAULT_STYLES.stepListStyle;

export const stepItemStyle = DEFAULT_STYLES.stepItemStyle;

export const activeStepNumberStyle = DEFAULT_STYLES.activeStepNumberStyle;

export const activeStepTitleStyle = DEFAULT_STYLES.activeStepTitleStyle;

export const completedStepNumberStyle = DEFAULT_STYLES.completedStepNumberStyle;

export const completedStepTitleStyle = DEFAULT_STYLES.completedStepTitleStyle;

export const pendingStepNumberStyle = DEFAULT_STYLES.pendingStepNumberStyle;

export const pendingStepTitleStyle = DEFAULT_STYLES.pendingStepTitleStyle;

export const stepSubtitleStyle = DEFAULT_STYLES.stepSubtitleStyle;

export const stepTextStyle = DEFAULT_STYLES.stepTextStyle;

export const navigationStyle = DEFAULT_STYLES.navigationStyle;

export const navigationButtonStyle = DEFAULT_STYLES.navigationButtonStyle;
...
export const step6FormStyle = DEFAULT_STYLES.step6FormStyle;
