...
// IMPORTANT:
//
// Header and every desktop row use this exact same 9-column
// template.
//
// The View action is included in the shared geometry.
//
// This prevents Principal / Outstanding / Loan Date / Status
